...
mod tests {
    ...
    │   ├──<id>
    │   │   └──emails
    │   │       └──[GET] -> salvo_t::routing::router::tests::fake_handler
    │   └──<id>/articles/<aid>
    │       ├──[GET] -> salvo_t::routing::router::tests::fake_handler
    │       └──[DELETE] -> salvo_t::routing::router::tests::fake_handler
    └──articles
        ├──<id>/authors/<aid>
        │   ├──[GET] -> salvo_t::routing::router::tests::fake_handler
        │   └──[DELETE] -> salvo_t::routing::router::tests::fake_handler
...
"#
    ...
    fn test_router_detect11() {
        let router = Router::new().push(
            Router::with_path(r"avatars/<width:/\d+/>x<height:/\d+/>.<ext>").handle(fake_handler),
        );
    ...
    fn test_router_detect12() {
        let router = Router::new()
            .push(Router::with_path("/.well-known/acme-challenge/<token>").handle(fake_handler));
